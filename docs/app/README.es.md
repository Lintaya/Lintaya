# Guías de usuario de Lintaya

[English](README.md) | Español

Estas guías explican cómo usar Lintaya desde la PWA. Comienza con [Primeros pasos](get-started/introduccion.es.md) y después explora el área relacionada con tu tarea:

- [Bloques](block/introduccion.es.md)
- [Boards y módulos](module/introduccion.es.md)
- [Dashboards](dashboard/introduccion.es.md)
